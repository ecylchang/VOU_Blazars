...
echo conesearch --db ${HERE}/cats1.ini --catalog 4XMM-DR9 --ra $ranh --dec $decnh --radius $sfov --runit arcmin --columns default -o tmp/${pidnm}4xmmdr9.1.csv >> tmp/${pidnm}vosearch.txt
