...
c
      IMPLICIT none
      INTEGER*4 ier, lu_in, ia,xray_type,lu_output, in,k, length,spec_type(5000,5000),im,imaxi
      ...
      real*4 errrad,errmaj,errmin,errang,savemjy(10000),mjdstart(5000,5000),mjdend(5000,5000),mjdavg
